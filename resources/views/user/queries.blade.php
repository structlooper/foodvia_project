                                ...
                                <div class="profile-right">
                                    ...
                                    <div class="profile-coupons">
                                        ...
                                        <div class="profile-coupons-block row">
                                            ...
                                            <div class="helppanel">
                                                @if(Setting::get('queries'))
                                                <p>{!!Setting::get('queries')!!}</p>
                                                @else
                                                <br/>
                                                <p><b>I want to unsubscribe from Foddie communications</b><br/>
                                                
                                                Please drop us an email mentioning the channels you would like to be unsubscribed from. We will take an action and confirm within 24-48 hours</p>
