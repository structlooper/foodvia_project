                ...
                <form  class="popup-form" method="POST" id="register_form" action="{{ url('/register') }}">
                    ...
                    <div id="first_step">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-xs-3">
                                <input type="text" id="country_code2" name="country_code" class="form-control"  value="+91">
                            </div>
...
$("#country_code").easyAutocomplete(options);
 var my_otp='';
    function smsLogin(){
        var countryCode = document.getElementById("country_code2").value;
        var phoneNumber = document.getElementById("phone_number").value;
        if(countryCode!=''){
        //var code = $('.selected-dial-code').html(); 
        //$('#country_code').val(code);
        var countryCode = "+91";//document.getElementById("country_code").value;
        var phoneNumber = document.getElementById("phone_number").value;
