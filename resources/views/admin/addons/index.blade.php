            ...
            @endif
                ...
                <div class="heading-elements">
                    <ul class="list-inline mb-0">
                        ...
                        <li><a href="{{ route('admin.addons.create') }}?shop={{Request::get('shop')}}" class="btn btn-primary add-btn btn-darken-3">@lang('inventory.addons.add_addon')</a></li>
                    </ul>
                </div>
            </div>
                            ...
                            @forelse($Addons as $Index => $Addon)
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <form id="resource-delete-{{ $Addon->id }}" action="{{ route('admin.addons.destroy', $Addon->id)}}" method="POST">
                                            {{ csrf_field() }}
                                            {{ method_field('DELETE') }}
                                        </form>
                                        @endif
