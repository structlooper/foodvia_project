                            ...
                            <div class="col-xl-4 col-lg-5 mb-md-40">
                                <ul class="step-steps steps-1">
                                    ...
                                    <li class="stepbtn" id="step4">
                                        <a href="#"> <span class="number"></span>
                                            <span class="step-name">Save & Preview</span>
                                        </a>
                                    </li>
                                </ul>
                                <ul class="step-steps steps-2">
                                    <li class="add-res-tab active" id="stepbtn1"> <a href="#" class="add-res-tab">General Info</a>
                                    </li>
                                    ...
                                    <li class="add-res-tab" id="stepbtn4"> <a href="#" class="add-res-tab">Save & Preview</a>
                                    </li>
                                </ul>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" name="#" class="form-control form-control-submit" placeholder="i.e Pizza Hut">
                                                        </div>
                                                    </div>
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                    ...
                                                    <div class="col-md-12">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="email" name="#" class="form-control form-control-submit" placeholder="i.e alard@example.com ">
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="row">
                                            ...
                                            <div class="row">
                                                <div class="col-lg-6">
                                                    <div class="package-box main-box">
                                                        <div class="package-img">
                                                            <a href="#">
                                                                <img src={{ asset("website/assets/img/package/package-1.jpg") }} class="img-fluid full-width" alt="package image">
                                                            </a>
                                                        </div>
                                                ...
                                                <div class="col-lg-6">
                                                    <div class="package-box main-box">
                                                        <div class="package-img">
                                                            <a href="#">
                                                                <img src={{ asset("website/assets/img/package/package-2.jpg") }} class="img-fluid full-width" alt="package image">
                                                            </a>
                                                        </div>
                                                        <div class="package-caption padding-20 bg-black">
                                                            <div class="package-item-first">
                                                ...
                                                <div class="row text-left">
                                                        ...
                                                        <div class="product-box mb-xl-20">
                                                            <div class="product-img">
                                                                <a href="restaurant.html">
                                                                    <img src={{ asset("website/assets/img/package/shop-2.jpg") }} class="img-fluid full-width" alt="product-img">
                                                                </a>
                                                                <div class="overlay">
                                                    ...
                                                    <div class="col-lg-6">
                                                        <div class="product-box mb-xl-20">
                                                            <div class="product-img">
                                                                <a href="restaurant.html">
                                                                    <img src={{ asset("website/assets/img/package/shop-1.jpg") }} class="img-fluid full-width" alt="product-img">
                                                                </a>
                                                                <div class="overlay">
                                                                    <div class="product-tags padding-10"> <span class="circle-tag">
                                                                            <img src={{ asset("website/assets/img/svg/013-heart-1.svg") }} alt="tag">
                    ...
                    <div class="swiper-wrapper">
                        <div class="swiper-slide">
                            <div class="large-product-box p-relative pb-0">
                                <img src={{ asset("website/assets/img/sidebanner-1.jpg") }} class="img-fluid full-width" alt="image">
                            </div>
                        </div>
                        <div class="swiper-slide">
                            <div class="large-product-box p-relative pb-0">
                                <img src={{ asset("website/assets/img/sidebanner-2.jpg") }} class="img-fluid full-width" alt="image">
                            </div>
                        </div>
                        <div class="swiper-slide">
                            <div class="large-product-box p-relative pb-0">
                                <img src={{ asset("website/assets/img/sidebanner-3.jpg") }} class="img-fluid full-width" alt="image">
                            </div>
                        </div>
                        <div class="swiper-slide">
                            <div class="large-product-box p-relative pb-0">
