    ...
    <section class="about-us-slider swiper-container p-relative">
        <div class="swiper-wrapper">
            <div class="swiper-slide slide-item">
                <img src={{ asset("website/assets/img/about/blog/1920x700/banner-1.jpg") }} class="img-fluid full-width" alt="Banner">
            ...
            <div class="swiper-slide slide-item">
                <img src={{ asset("website/assets/img/about/blog/1920x700/banner-2.jpg") }} class="img-fluid full-width" alt="Banner">
                <div class="transform-center">
                    <div class="container">
            ...
            <div class="swiper-slide slide-item">
                <img src={{ asset("website/assets/img/about/blog/1920x700/banner-3.jpg") }} class="img-fluid full-width" alt="Banner">
                <div class="transform-center">
                    <div class="container">
            ...
            <div class="row align-items-center">
                <div class="col-lg-6">
                    <div class="history-title mb-md-40">
                        <h2 class="text-light-black">A History Has Written For Foodvia Explore <span class="text-light-green">more Our Story</span></h2>
                    ...
                    <div class="row align-items-center">
                        <div class="col-lg-6 col-sm-6 col-md-6">
                            <div class="histry-img mb-xs-20">
                                <img src={{ asset("website/assets/img/about/blog/255x200/about-section-3.jpg") }} class="img-fluid full-width" alt="Histry">
                            </div>
                        </div>
                        <div class="col-lg-6 col-sm-6 col-md-6">
                            <div class="histry-img mb-xl-20">
                                <img src={{ asset("website/assets/img/about/blog/255x200/about-section-1.jpg") }} class="img-fluid full-width" alt="Histry">
                            </div>
                            <div class="histry-img">
                                <img src={{ asset("website/assets/img/about/blog/255x200/about-section-2.jpg") }} class="img-fluid full-width" alt="Histry">
                            </div>
                        </div>
                    </div>
                </div>
    ...
    <section class="section-padding how-it-works bg-light-theme">
        <div class="container">
            ...
            <div class="row">
                ...
                <img src={{ asset("website/assets/img/001-search.png") }} alt="icon">
                ...
                <div class="col-lg-3 col-sm-6">
                    <div class="how-it-works-box arrow-2">
                        <div class="how-it-works-box-inner"> <span class="icon-box">
                <img src={{ asset("website/assets/img/004-shopping-bag.png") }} alt="icon">
                ...
                <div class="col-lg-3 col-sm-6">
                    <div class="how-it-works-box arrow-1">
                        <div class="how-it-works-box-inner"> <span class="icon-box">
                <img src={{ asset("website/assets/img/002-stopwatch.png") }} alt="icon">
                ...
                <div class="col-lg-3 col-sm-6">
                    <div class="how-it-works-box">
                        <div class="how-it-works-box-inner"> <span class="icon-box">
                <img src={{ asset("website/assets/img/003-placeholder.png") }} alt="icon">
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="blog-box mb-xl-20">
                        ...
                        <article class="post">
                            <div class="blog-img p-relative">
                                <a href="#">
                                    <img src={{ asset("website/assets/img/about/blog/740x442/blog-1.jpg") }} alt="blog-img">
                                </a>
                                <div class="overlay padding-20">
                                    <div class="blog-meta">
                                        <h4 class="text-custom-white mb-2 fw-600">New locations where you can now get your Foodvia® delivered</h4>
                                        <a href="blog-details.html" class="text-custom-white fw-700 fs-18">Read More</a>
                                    </div>
                                </div>
                            </div>
                        </article>
                            ...
                            <div class="blog-list padding-tb-10">
                                ...
                                <article class="side-post padding-20 u-line">
                                    <div class="content-wrap">
                                        ...
                                        <h6 class="entry-title no-margin">
                                            <a href="blog-details.html" class="text-light-black">How We designed It: pizza delivery from the ground up only for you.</a>
                                        </h6>
                                    </div>
                                    <div class="thumb-img">
                                        <a href="blog-details.html">
                                            <img src={{ asset("website/assets/img/blog/100x100/popularpost-1.jpg") }} alt="thumb-img">
                                        </a>
                                    </div>
                                </article>
                                <!-- article 1 -->
                                ...
                                <article class="side-post padding-20 u-line">
                                    <div class="content-wrap">
                                        ...
                                        <h6 class="entry-title no-margin">
                                            <a href="blog-details.html" class="text-light-black">How We Made It: Grimaldi's traditional New York-style pizza italian style</a>
                                        </h6>
                                    </div>
                                    <div class="thumb-img">
                                        <a href="blog-details.html">
                                            <img src={{ asset("website/assets/img/blog/100x100/popularpost-2.jpg") }} alt="thumb-img">
                                        </a>
                                    </div>
                                </article>
                                <!-- article 1 -->
                                ...
                                <article class="side-post padding-20">
                                    <div class="content-wrap">
                                        ...
                                        <h6 class="entry-title no-margin">
                                            <a href="blog-details.html" class="text-light-black">How We Made It: Grimaldi's traditional New York-style pizza</a>
                                        </h6>
                                    </div>
                                    <div class="thumb-img">
                                        <a href="blog-details.html">
                                            <img src={{ asset("website/assets/img/blog/100x100/popularpost-3.jpg") }} alt="thumb-img">
                                        </a>
                                    </div>
                                </article>
                                <!-- article 1 -->
                    ...
                    <div class="ad-img p-relative">
                        <img src={{ asset("website/assets/img/about/blog/1110x350/hbanner-1.jpg") }} class="img-fluid full-width" alt="#">
                        <div class="overlay">
                            <div class="content-box transform-center">
                                <p class="text-custom-white">Foodvia</p>
                                ...
                                <a href="restaurant.html" class="btn-first white-btn">View All</a>
                            </div>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="swiper-wrapper">
                            <div class="swiper-slide">
                                <div class="feedback-item-two">
                                    <img src={{ asset("website/assets/img/about/72x72/user-1.png") }} alt="Feedback">
                                    <p class="text-custom-white fs-16">I like Foodvia and as compared to other company it's polices and customers support is very good easy to reach., also many time they unable to delivered. Quis ipsum suspendisse ultrices gravida. Risus commodo viverra maecenas accumsan lacus vel facilisist amet, sed do eiusm.</p>
