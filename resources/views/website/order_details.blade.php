...
@section('main_content')
 ...
 <div class="banner-adv-bg">
    <div id="banner-adv" class="banner-adv">
          <a href="#"> <span class="text">Get FREE DELIVERY on your first order.</span>
                                ...
                                <div class="col-lg-12">
                                    <div class="checkout-product">
                                        <div class="img-name-value">
                                            <div class="product-img">
                                                <a href="#">
                                                    <img src={{ asset("website/assets/img/details/dish-1.jpg") }} alt="#">
                                                </a>
                                            </div>
                                    ...
                                    <div class="checkout-product">
                                        <div class="img-name-value">
                                            <div class="product-img">
                                                <a href="#">
                                                    <img src={{ asset("website/assets/img/details/dish-2.jpg") }} alt="#">
                                                </a>
                                            </div>
                                            <div class="product-value"> <span class="text-light-white">2</span>
                                            </div>
                                    ...
                                    <div class="checkout-product">
                                        <div class="img-name-value">
                                            <div class="product-img">
                                                <a href="#">
                                                    <img src={{ asset("website/assets/img/details/dish-3.jpg") }} alt="#">
                                                </a>
                                            </div>
                                            <div class="product-value"> <span class="text-light-white">2</span>
                                            </div>
                                    ...
                                    <div class="checkout-product">
                                        <div class="img-name-value">
                                            <div class="product-img">
                                                <a href="#">
                                                    <img src={{ asset("website/assets/img/details/dish-4.jpg") }} alt="#">
                                                </a>
                                            </div>
                                            <div class="product-value"> <span class="text-light-white">2</span>
                                            </div>
                                    ...
                                    <div class="checkout-product">
                                        <div class="img-name-value">
                                            <div class="product-img">
                                                <a href="#">
                                                    <img src={{ asset("website/assets/img/details/dish-5.jpg") }} alt="#">
                                                </a>
                                            </div>
                                            <div class="product-value"> <span class="text-light-white">2</span>
                                            </div>
