                        ...
                        <div class="swiper-slide">
                            <a href="restaurant.html" class="categories">
                                <div class="icon text-custom-white bg-light-green ">
                                    <img src={{ asset("website/assets/img/restaurants/125x125/cuisine-1.jpg") }} class="rounded-circle" alt="categories">
                ...
                <div class="row">
                    <div class="col-lg-4 col-md-6 col-sm-6">
                        <div class="product-box mb-xl-20">
                            <div class="product-img">
                                <a href="restaurant.html">
                                    <img src={{ asset("website/assets/img/restaurants/255x150/shop-23.jpg") }} class="img-fluid full-width" alt="product-img">
                                </a>
                                <div class="overlay">
