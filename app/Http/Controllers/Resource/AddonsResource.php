    ...
    public function store(Request $request)
    {
        ...
        try {
            ...
            if($request->hasFile('avatar')) {
                $Addon['avatar'] = asset('../../storage/app/public/app/public/'.$request->avatar->store('addons'));
            }
    ...
    public function update(Request $request, $id)
    {
       $this->validate($request, [
        ...
        try {
            ...
            $Update = $request->all();
            if($request->hasFile('avatar')) {
                $Update['avatar'] = asset('../../storage/app/public/app/public/'.$request->avatar->store('addons'));
            } else {
                unset($Update['avatar']);
            }
